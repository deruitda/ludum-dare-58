...
@export var potential_income_streams: PotentialIncomeStreams
...
func _ready() -> void:
	...
	potential_income_streams.set_potential_income_stream_manager(potential_income_streams_manager)
